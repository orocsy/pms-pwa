(function() {
    ...
    .controller('pmsDataEntryCtrl', ['$scope', 'pmsDashboardPageService', pmsDataEntryCtrl]);

    function pmsDataEntryCtrl($scope, pmsDashboardPageService) {
        var pmsDataEntryVm = this;
        pmsDataEntryVm.addText = addText;
        pmsDataEntryVm.options = {
          responsive: true,
          onAnimationComplete : pmsDataEntryVm.addText
        };
        ...
        function addText() {
          ...
          ctx.font = '25px Arial';
          ctx.fillStyle = 'black';
          ctx.fillText(pmsDataEntryVm.centerTxt, cx, cy);
        }
    }
})();
